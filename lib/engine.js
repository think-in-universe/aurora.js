...
import { SubmitResult, FunctionCallArgs, GetStorageAtArgs, InitCallArgs, NewCallArgs, ViewCallArgs, FungibleTokenMetadata, TransactionStatus, GetErc20FromNep141CallArgs, } from './schema.js';
    ...
    submit(input) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return (yield this.callMutativeFunction('submit', inputBytes)).map(({ output }) => SubmitResult.decode(Buffer.from(output)));
            }
            catch (error) {
                //console.error(error); // DEBUG
                return Err(error.message);
            ...
            try {
                ...
                switch (error === null || error === void 0 ? void 0 : error.type) {
                    case 'FunctionCallError': {
                        const errorKind = (_a = error === null || error === void 0 ? void 0 : error.kind) === null || _a === void 0 ? void 0 : _a.ExecutionError;
                        if (errorKind) {
