...
import { SubmitResult, FunctionCallArgsV2, GetStorageAtArgs, InitCallArgs, NewCallArgs, ViewCallArgs, FungibleTokenMetadata, TransactionStatus, GetErc20FromNep141CallArgs, WrappedSubmitResult, CallArgs, } from './schema.js';
...
export class Engine {
    ...
    static connect(options, env) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const signer = yield near.account(signerID.toString());
            return new Engine(near, keyStore, signer, networkID, contractID);
        });
    }
    install(contractCode) {
        return __awaiter(this, void 0, void 0, function* () {
            const contractAccount = (yield this.getAccount()).unwrap();
    ...
    initialize(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tx = yield this.promiseAndThen(this.callMutativeFunction('new', newArgs.encode()), (_) => this.callMutativeFunction('new_eth_connector', connectorArgs.encode()));
            return tx.map(({ id }) => id);
        });
    }
    ...
    getAccount() {
        return __awaiter(this, void 0, void 0, function* () {
            return Ok(yield this.near.account(this.contractID.toString()));
        });
    }
    getBlockHash() {
        return __awaiter(this, void 0, void 0, function* () {
            const contractAccount = (yield this.getAccount()).unwrap();
            const state = (yield contractAccount.state());
    ...
    getBlock(blockID, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const provider = this.near.connection.provider;
            return yield BlockProxy.fetch(provider, blockID, options);
        });
    }
    hasBlock(blockID) {
        return __awaiter(this, void 0, void 0, function* () {
            const provider = this.near.connection.provider;
            return yield BlockProxy.lookup(provider, blockID);
        });
    }
    getCoinbase() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getVersion(options) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.callFunction('get_version', undefined, options)).map((output) => output.toString());
        });
    }
    getOwner(options) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.callFunction('get_owner', undefined, options)).andThen((output) => AccountID.parse(output.toString()));
        });
    }
    getBridgeProvider(options) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.callFunction('get_bridge_provider', undefined, options)).andThen((output) => AccountID.parse(output.toString()));
        });
    }
    getChainID(options) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.callFunction('get_chain_id', undefined, options);
    ...
    deployCode(bytecode) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const outcome = yield this.callMutativeFunction('deploy_code', args);
    ...
    call(contract, input, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (yield this.callMutativeFunction('call', args.encode())).map(({ output }) => output);
        });
    }
    submit(input) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return (yield this.callMutativeFunction('submit', inputBytes)).map(({ output, gasBurned, tx }) => {
    ...
    getCode(address, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.callFunction('get_code', args, options);
        });
    }
    getBalance(address, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const args = address.toBytes();
            const result = yield this.callFunction('get_balance', args, options);
            return result.map(toBigIntBE);
        });
    }
    getNonce(address, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const args = address.toBytes();
            const result = yield this.callFunction('get_nonce', args, options);
            return result.map(toBigIntBE);
        });
    }
    getStorageAt(address, key, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const args = new GetStorageAtArgs(address.toBytes(), parseHexString(defaultAbiCoder.encode(['uint256'], [key])));
            const result = yield this.callFunction('get_storage_at', args.encode(), options);
            return result.map(toBigIntBE);
        });
    }
    getAuroraErc20Address(nep141, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const args = new GetErc20FromNep141CallArgs(nep141.id);
            const result = yield this.callFunction('get_erc20_from_nep141', args.encode(), options);
            return result.map((output) => {
                return Address.parse(output.toString('hex')).unwrap();
            });
        });
    }
    getNEP141Account(erc20, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const args = erc20.toBytes();
            const result = yield this.callFunction('get_nep141_from_erc20', args, options);
            return result.map((output) => {
    ...
    getStorage() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const contractAccount = (yield this.getAccount()).unwrap();
            const records = yield contractAccount.viewState('', { finality: 'final' });
    ...
    callFunction(methodName, args, options) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    callMutativeFunction(methodName, args) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.signer.functionCall(this.contractID.toString(), methodName, this.prepareInput(args), gas);
                if (typeof result.status === 'object' &&
                    typeof result.status.SuccessValue === 'string') {
                    const transactionId = (_a = result === null || result === void 0 ? void 0 : result.transaction_outcome) === null || _a === void 0 ? void 0 : _a.id;
                    return Ok({
                        id: TransactionID.fromHex(result.transaction.hash),
                        output: Buffer.from(result.status.SuccessValue, 'base64'),
                        tx: transactionId,
                        gasBurned: yield this.transactionGasBurned(transactionId),
                    });
                }
                ...
                switch (error === null || error === void 0 ? void 0 : error.type) {
                    case 'FunctionCallError': {
                        const transactionId = (_b = error === null || error === void 0 ? void 0 : error.transaction_outcome) === null || _b === void 0 ? void 0 : _b.id;
                        const details = {
                            tx: transactionId,
                            gasBurned: yield this.transactionGasBurned(transactionId),
                        };
                        const errorKind = (_c = error === null || error === void 0 ? void 0 : error.kind) === null || _c === void 0 ? void 0 : _c.ExecutionError;
                        if (errorKind) {
    ...
    transactionGasBurned(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const transactionStatus = yield this.near.connection.provider.txStatus(base58ToBytes(id), this.contractID.toString());
